...
public sealed partial class MainWindow : Window
{
    ...
    public void NavigateToAddConnection(RcloneGui.Features.Sftp.Models.SftpConnection? connectionToEdit = null)
    {
    ...
    /// </summary>
    public void NavigateToSftpConnection(RcloneGui.Features.Sftp.Models.SftpConnection? connectionToEdit)
    {
        ContentFrame.BackStack.Clear();
        ContentFrame.ForwardStack.Clear();
        ContentFrame.Navigate(typeof(SftpConnectionView), connectionToEdit);
    ...
    /// </summary>
    public void NavigateToFtpConnection(RcloneGui.Features.Ftp.Models.FtpConnection? connectionToEdit)
    {
        ContentFrame.BackStack.Clear();
        ContentFrame.ForwardStack.Clear();
        ContentFrame.Navigate(typeof(FtpConnectionView), connectionToEdit);
