...
/// <summary>
/// Service for executing rclone commands.
/// </summary>
public class RcloneService : IRcloneService
{
    ...
    public RcloneService(IConfigManager configManager)
    {
    ...
    public async Task<bool> CreateSftpRemoteAsync(SftpConnection connection)
    {
    ...
    {
        var result = await RunRcloneAsync("listremotes");
        if (result.Success && !string.IsNullOrEmpty(result.Output))
        {
